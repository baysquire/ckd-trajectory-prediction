-- Cohort extraction for Paper 1: CKD patients from MIMIC-IV
--
-- Inclusion criteria:
--   - Adult patients with at least one CKD diagnosis (ICD-10: N18.*, ICD-9: 585.*)
--   - At least 3 creatinine measurements spanning >= 180 days
--   - Creatinine values between 0.1 and 30.0 mg/dL
--
-- Comorbidity flags derived from diagnosis codes:
--   - Diabetes: ICD-10 E10.*, E11.*; ICD-9 250.*
--   - Hypertension: ICD-10 I10.*; ICD-9 401.*
